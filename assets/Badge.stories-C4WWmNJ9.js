import{_ as y,c as f,r as h,n as b,o as _}from"./iframe-Bw9eQp_X.js";const m={__name:"Badge",props:{variant:{type:String,default:"primary",validator:a=>["primary","secondary","success","danger","warning","info","light","dark"].includes(a)}},setup(a){return(v,S)=>(_(),f("span",{class:b(["glass-badge",`glass-badge--${a.variant}`])},[h(v.$slots,"default",{},void 0,!0)],2))}},s=y(m,[["__scopeId","data-v-03886f9a"]]);m.__docgenInfo={exportName:"default",displayName:"Badge",description:"",tags:{},props:[{name:"variant",type:{name:"string"},defaultValue:{func:!1,value:"'primary'"},values:["primary","secondary","success","danger","warning","info","light","dark"]}],slots:[{name:"default"}],sourceFiles:["/Users/surajbharti/projects/glass-ui/src/components/UI/Badge.vue"]};const k={title:"Components/Badge",component:s,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
...
Use the controls to change the badge variant and label.
  ...
  \`
})`,...(B=(p=n.parameters)==null?void 0:p.docs)==null?void 0:B.source}}};const x=["Primary","Success","AllBadges"];export{n as AllBadges,e as Primary,r as Success,x as __namedExportsOrder,k as default};
