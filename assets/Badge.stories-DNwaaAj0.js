import{c as y,d as f,n as h,e as b}from"./iframe-DRmMUMN1.js";import{_}from"./_plugin-vue_export-helper-DlAUqK2U.js";const m={__name:"Badge",props:{variant:{type:String,default:"primary",validator:a=>["primary","secondary","success","danger","warning","info","light","dark"].includes(a)}},setup(a){return(v,S)=>(b(),y("span",{class:h(["glass-badge",`glass-badge--${a.variant}`])},[f(v.$slots,"default",{},void 0,!0)],2))}},s=_(m,[["__scopeId","data-v-03886f9a"]]);m.__docgenInfo={exportName:"default",displayName:"Badge",description:"",tags:{},props:[{name:"variant",type:{name:"string"},defaultValue:{func:!1,value:"'primary'"},values:["primary","secondary","success","danger","warning","info","light","dark"]}],slots:[{name:"default"}],sourceFiles:["/Users/surajbharti/projects/glass-ui/src/components/UI/Badge.vue"]};const x={title:"Components/Badge",component:s,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
