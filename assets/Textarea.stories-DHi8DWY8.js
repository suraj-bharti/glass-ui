import{f as T,c as V,e as S,d as w}from"./iframe-BC06G_je.js";import{_ as C}from"./_plugin-vue_export-helper-DlAUqK2U.js";const W=["placeholder","disabled","rows","value"],y={__name:"Textarea",props:{modelValue:String,placeholder:{type:String,default:""},disabled:{type:Boolean,default:!1},rows:{type:[String,Number],default:3},borderColor:{type:String,default:"grey"},borderWidth:{type:String,default:"1px"},borderType:{type:String,default:"solid",validator:e=>["solid","dotted","dashed","double","groove","ridge","inset","outset","none","hidden"].includes(e)},borderRadius:{type:String,default:""}},setup(e){const o=e,x=T(()=>({border:`${o.borderWidth} ${o.borderType} ${o.borderColor}`,borderRadius:o.borderRadius||void 0}));return(h,s)=>(w(),V("textarea",{class:"glass-textarea",placeholder:e.placeholder,disabled:e.disabled,rows:e.rows,value:e.modelValue,onInput:s[0]||(s[0]=v=>h.$emit("update:modelValue",v.target.value)),style:S(x.value)},null,44,W))}},f=C(y,[["__scopeId","data-v-7f493733"]]);y.__docgenInfo={exportName:"default",displayName:"Textarea",description:"",tags:{},props:[{name:"modelValue",type:{name:"string"}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"disabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"rows",type:{name:"string|number"},defaultValue:{func:!1,value:"3"}},{name:"borderColor",type:{name:"string"},defaultValue:{func:!1,value:"'grey'"}},{name:"borderWidth",type:{name:"string"},defaultValue:{func:!1,value:"'1px'"}},{name:"borderType",type:{name:"string"},defaultValue:{func:!1,value:"'solid'"},values:["solid","dotted","dashed","double","groove","ridge","inset","outset","none","hidden"]},{name:"borderRadius",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],events:[{name:"update:modelValue"}],sourceFiles:["/Users/surajbharti/projects/glass-ui/src/components/UI/Textarea.vue"]};const B={title:"Components/Textarea",component:f,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
...
Use the controls to change the placeholder, disabled state, number of rows, border type, border color, border width, and border radius. Type in the textarea to see two-way binding in action.
...
})`,...(i=(n=r.parameters)==null?void 0:n.docs)==null?void 0:i.source}}};var p,u,c;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`args => ({
  components: {
    Textarea
  },
  setup() {
  ...
  template: \`<Textarea v-bind="args" v-model="args.modelValue" />\`
})`,...(c=(u=a.parameters)==null?void 0:u.docs)==null?void 0:c.source}}};var m,b,g;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`args => ({
  components: {
    Textarea
  },
  setup() {
  ...
  template: \`<Textarea v-bind="args" v-model="args.modelValue" />\`
})`,...(g=(b=t.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};const D=["Default","WithCustomBorder","Disabled"];export{r as Default,t as Disabled,a as WithCustomBorder,D as __namedExportsOrder,B as default};
