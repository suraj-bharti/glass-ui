import{f as V,c as I,e as S,d as C}from"./iframe-BC06G_je.js";import{_ as T}from"./_plugin-vue_export-helper-DlAUqK2U.js";const W=["type","placeholder","disabled","value"],g={__name:"Input",props:{modelValue:String,type:{type:String,default:"text",validator:e=>["text","password","email","number"].includes(e)},placeholder:{type:String,default:""},disabled:{type:Boolean,default:!1},borderColor:{type:String,default:"blue"},borderWidth:{type:String,default:"1px"},borderType:{type:String,default:"solid",validator:e=>["solid","dotted","dashed","double","groove","ridge","inset","outset","none","hidden"].includes(e)},borderRadius:{type:String,default:""}},setup(e){const t=e,h=V(()=>({border:t.borderColor?`${t.borderWidth} ${t.borderType} ${t.borderColor}`:void 0,borderRadius:t.borderRadius||void 0}));return(v,n)=>(C(),I("input",{class:"glass-input",type:e.type,placeholder:e.placeholder,disabled:e.disabled,value:e.modelValue,onInput:n[0]||(n[0]=x=>v.$emit("update:modelValue",x.target.value)),style:S(h.value)},null,44,W))}},f=T(g,[["__scopeId","data-v-a700eda9"]]);g.__docgenInfo={exportName:"default",displayName:"Input",description:"",tags:{},props:[{name:"modelValue",type:{name:"string"}},{name:"type",type:{name:"string"},defaultValue:{func:!1,value:"'text'"},values:["text","password","email","number"]},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"disabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"borderColor",type:{name:"string"},defaultValue:{func:!1,value:"'blue'"}},{name:"borderWidth",type:{name:"string"},defaultValue:{func:!1,value:"'1px'"}},{name:"borderType",type:{name:"string"},defaultValue:{func:!1,value:"'solid'"},values:["solid","dotted","dashed","double","groove","ridge","inset","outset","none","hidden"]},{name:"borderRadius",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],events:[{name:"update:modelValue"}],sourceFiles:["/Users/surajbharti/projects/glass-ui/src/components/UI/Input.vue"]};const _={title:"Components/Input",component:f,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
...
Use the controls to change the input type, placeholder, disabled state, border type, border color, border width, and border radius. Type in the input to see two-way binding in action and adjust the border appearance dynamically.
  ...
  template: \`<Input v-bind="args" v-model="args.modelValue" />\`
})`,...(y=(b=a.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};const B=["Default","WithCustomBorder","Disabled"];export{r as Default,a as Disabled,o as WithCustomBorder,B as __namedExportsOrder,_ as default};
