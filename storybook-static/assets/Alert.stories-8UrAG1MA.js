import{r as z,w as q,o as G,c as r,a as s,b as H,d as y,t as f,n as J,e as a,f as K,F as M,g as Q,h as R}from"./iframe-DRmMUMN1.js";import{_ as X}from"./_plugin-vue_export-helper-DlAUqK2U.js";const Y={key:0,class:"glass-alert__icon"},Z={class:"glass-alert__content"},ee={key:0,class:"glass-alert__title"},te={key:1,class:"glass-alert__description"},O={__name:"Alert",props:{variant:{type:String,default:"info",validator:e=>["primary","secondary","success","danger","warning","info","light","dark"].includes(e)},dismissible:{type:Boolean,default:!1},timeout:{type:[Number,String],default:null},icon:{type:[String,Object,Function],default:null},title:{type:String,default:""},description:{type:String,default:""}},setup(e){const W=e,g=z(!0);let i=null;function _(){g.value=!1}return q(()=>W.timeout,t=>{i&&clearTimeout(i),t&&Number(t)>0&&(i=setTimeout(()=>{g.value=!1},Number(t)))},{immediate:!0}),G(()=>{i&&clearTimeout(i)}),(t,se)=>g.value?(a(),r("div",{key:0,class:J(["glass-alert",[`glass-alert--${e.variant}`,e.dismissible?"glass-alert--dismissible":""]]),role:"alert"},[e.icon||t.$slots.icon?(a(),r("span",Y,[y(t.$slots,"icon",{},()=>[typeof e.icon=="string"?(a(),r(M,{key:0},[Q(f(e.icon),1)],64)):e.icon?(a(),K(R(e.icon),{key:1})):s("",!0)],!0)])):s("",!0),H("div",Z,[e.title?(a(),r("div",ee,f(e.title),1)):s("",!0),e.description?(a(),r("div",te,f(e.description),1)):s("",!0),!e.title&&!e.description?y(t.$slots,"default",{key:2},void 0,!0):s("",!0)]),e.dismissible?(a(),r("button",{key:1,class:"glass-alert__close",onClick:_,"aria-label":"Dismiss",type:"button"},"×")):s("",!0)],2)):s("",!0)}},P=X(O,[["__scopeId","data-v-7512bc71"]]);O.__docgenInfo={exportName:"default",displayName:"Alert",description:"",tags:{},props:[{name:"variant",type:{name:"string"},defaultValue:{func:!1,value:"'info'"},values:["primary","secondary","success","danger","warning","info","light","dark"]},{name:"dismissible",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"timeout",type:{name:"number|string"},defaultValue:{func:!1,value:"null"}},{name:"icon",type:{name:"string|object|func"},defaultValue:{func:!1,value:"null"}},{name:"title",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"description",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],slots:[{name:"icon"},{name:"default"}],sourceFiles:["/Users/surajbharti/projects/glass-ui/src/components/UI/Alert.vue"]};const re={title:"Components/Alert",component:P,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
...
Use the controls to change the alert variant, message, make it dismissible, and set an optional timeout for auto-dismiss.
  ...
  template: \`<Alert v-bind="args">{{ args.default }}</Alert>\`
})`,...(L=(E=p.parameters)==null?void 0:E.docs)==null?void 0:L.source}}};const ie=["Default","Info","Success","Warning","Danger","Light","Dark"];export{d as Danger,p as Dark,o as Default,l as Info,m as Light,c as Success,u as Warning,ie as __namedExportsOrder,re as default};
